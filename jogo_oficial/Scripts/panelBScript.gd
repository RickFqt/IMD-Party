...
@onready var LabelQuestion = $Question_p2 #Obtenha o caminho para a questão
@onready var LabelScore = $ScoreLabel_p2 #Obtenha o caminho para o score
@onready var ButtonA = $ButtonA_p2 #Obtenha o caminho para o botão A
@onready var ButtonB = $ButtonB_p2 #Obtenha o caminho para o botão B
@onready var ButtonC = $ButtonC_p2 #Obtenha o caminho para o botão C
@onready var ButtonD = $ButtonD_p2 #Obtenha o caminho para o botão D
@onready var textureA = $button1_p2 #Obtenha o caminho para o botão A
@onready var textureB = $button2_p2 #Obtenha o caminho para o botão B
@onready var textureC = $button3_p2 #Obtenha o caminho para o botão C
@onready var textureD = $button4_p2 #Obtenha o caminho para o botão D
...
func _input(event):
	if event is InputEventKey:
		if event.is_action_pressed("key_j"):
			...
			answer = 3
			_onAnswerSelected()
		elif event.is_action_pressed("key_ç"):
			answer = 4
			_onAnswerSelected()
